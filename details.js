...
function processProductFromList(allProducts) {
    ...
    const detailView = document.getElementById('product-detail-view');
    if (detailView) {
        detailView.innerHTML = `<div style="text-align:center; padding: 50px;"><p>Product not found.</p><a href="#" onclick="window.history.back(); return false;" style="color:var(--orange)">Back</a></div>`;
    }
    return false;
}
...
function renderDetails(p) {
    ...
    detailView.innerHTML = `
        ...
        <div class="info-section">
            ...
            <h1 class="detail-product-title" style="font-size: 2.3rem; margin: 10px 0; line-height: 1.2;">${p.name}</h1>
            ...
            <div class="branch-order-box">
                ...
                <div class="branch-buttons-grid single-button-grid">
                    <a href="https://wa.me/601112189026?text=${buildSingleWhatsAppMessage()}" class="whatsapp-branch-btn general-btn" target="_blank">
